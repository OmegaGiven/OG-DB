...
| Smart Glasses | Smart glasses &mdash; graphic display (colour vs mono, monocular / binocular) + FOV, audio type (open-ear / bone conduction), camera + quality, subscription requirement, battery (built-in / puck / phone-tethered), open source, privacy risk + which company gets your captured data. | [`/glasses/`](https://omegagiven.github.io/OG-DB/glasses/) | [`glasses.json`](glasses/glasses.json) |
